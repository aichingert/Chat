...
<div class="grid grid-cols-6 h-screen">
    <div class="col-span-2 border-r-4 border-onedark-darkblue h-screen">
        <div class="">
            ...
            <div class="h-10 flex items-center bg-onedark-darkblue px-2">
                <form class="flex items-center bg-onedark-gray w-full px-2 rounded-md">
                    ...
                    <input name="search" placeholder="search chats" class="placeholder-onedark-lightgray outline-none bg-inherit w-fit">
                </form>
            </div>
            <div>
